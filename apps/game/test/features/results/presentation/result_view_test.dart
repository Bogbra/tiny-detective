...
void main() {
  testWidgets('displays score, streak, feedback and explanation', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(home: ResultView(result: result)),
    );
  ...
  testWidgets('a streak multiple of 3 shows the milestone message', (
    tester,
  ) async {
    const result = CaseResult(
      correct: true,
  ...
  testWidgets('a non-milestone streak shows no milestone message', (
    tester,
  ) async {
    const result = CaseResult(
      correct: true,
  ...
  testWidgets(
    'an already-solved resubmission shows no milestone message even at a streak multiple of 3',
    (tester) async {
      const result = CaseResult(
        correct: true,
        score: 0,
